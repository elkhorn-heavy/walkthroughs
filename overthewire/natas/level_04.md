...
![Developer Tools](images/level_04/01_developer_tools.png)

Clicking the "Refresh page" link on the web page will re-send the network
requests for the page:

![Network Requests](images/level_04/02_network_requests.png)
...
![Index Request](images/level_04/03_index_request.png)
...
![Context Menu](images/level_04/04_context_menu.png)
...
![Edit and Resend](images/level_04/05_edit_and_resend.png)
